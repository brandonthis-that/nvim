...
-- vim.cmd("autocmd VimEnter * Neotree filesystem reveal left <split> winheight=10 winwidth=20")
...
require('lazy').setup({
  ...
  --=============CODE FOR NEOTREE==================
  {
    ...
    -- -- Autocommand should be outside the plugin table
  -- vim.api.nvim_create_autocmd("VimEnter", { command = "Neotree filesystem reveal right" })
...
--My own configs
    ...
    vim.opt.clipboard = "unnamedplus"
    vim.opt.scrolloff = 8
    vim.opt.inccommand = "split" --use :%s/to look for words to edit
    vim.opt.ignorecase = true
    vim.opt.termguicolors = true
    vim.g.netrw_banner = 0 --remove netrw leader
    vim.g.mapleader = " "
